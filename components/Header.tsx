...
export const Header: React.FC = () => {
  ...
  const navLinks = [
    ...
    { label: 'About', id: '#footer', sectionId: 'footer' },
  ];
        ...
        >
          ...
          <nav className="hidden md:flex items-center gap-2">
            {navLinks.map((link) => {
              ...
              if (isActive) {
                // Active State Style (Colored Button)
                if (isScrolled) {
                  // Light mode active
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`ml-4 px-6 py-2.5 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg transition-colors ${
